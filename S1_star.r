# SI with desired gains vs economic values (adjusted to include traits for which desired gain = 0), using Ian Mackay's notation.
# 09-04-2018, G. Slavov 
...
# Target traits and desired gains, including for traits for which desired gain = 0
idx<-c(1,4,8)
G_star<-G[,idx]
Q<-c(44,213,0)
